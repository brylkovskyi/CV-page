export const UserData = {
  ...
  photoURL: 'https://miro.medium.com/fit/c/256/256/1*_hSWANaRzkQqJOYCsxqtdA.jpeg',
  data: [
    {
      groupName: 'personal',
      groupData: [
...
<div style="display: flex;">
<div style="width: 35%">
<span style="text-transform: uppercase; font-weight: 500">DreamWork</span><br/>
<i style="font-size: 13px">XX.XXXX - XX.XXXX</i>
</div>
<div style="width: 65%; font-size: 14px">
<span style="font-weight: 500; font-size: 15px">Top performer</span><br/>
<i>Very complicated project</i><br/>
<span><i>Technologies: </i>Angular 239 and 100 more technologies</span>
</div>
</div>
<div style="display: flex; margin-top: 15px">
<div style="width: 35%">
<span style="text-transform: uppercase; font-weight: 500">Nightmare</span><br/>
<i style="font-size: 13px">XX.XXXX - present</i>
</div>
<div style="width: 65%; font-size: 14px">
<span style="font-weight: 500; font-size: 15px">Ghost buster</span><br/>
Ghost hunting and elimination <br/>
<span><i>Technologies: </i>Cosmic blaster, invisible web, intuition, imagination</span>
</div>
</div>
...
<li style="margin: 60px 0 -12px -28px; font-size: 24px; text-align: center">•</li>
</ul>
</div>
`
    },
...
<div style="width: 65%">
<span style="font-weight: 500">Specialist of Magic</span><br/>
<span>Hogwarts University</span>
</div>
</div>
<div style="display: flex; margin-top: 15px">
<div style="width: 35%">
...
<ul style="position: absolute; left: 31%; top: 9px; border-left: 2px solid #b0b0b0; padding-left: 13px; font-size: 13px; list-style-type: none">
<li style="margin: -16px 0 0 -28px; font-size: 24px; text-align: center">•</li>
<li style="margin: 22px 0 -12px -28px; font-size: 24px; text-align: center">•</li>
</ul>
</div>
`
    },
